...
int main(int /*argc*/, char* /*argv*/[]) {
    ...
    try {
        ...
        // Request D-Bus name
        connection->requestName(sdbus::ServiceName{"com.github.saim.VoiceAssistant"});
        ...
        std::cout << "Voice Assistant Service running on D-Bus" << std::endl;
        std::cout << "Bus name: com.github.saim.VoiceAssistant" << std::endl;
